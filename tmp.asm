...
section .text
    ...
    start_loop:
        ...
        and eax, 0xFFFFFFFF ; приведение значения CRC32 к 32-битному беззнаковому значению
        mov ebx, 0xEDB88320 ; константа для алгоритма CRC32
        xor eax, ebx ; комбинирование значения CRC32 с константой
        xor eax, edx ; комбинирование значения CRC32 с предыдущим значением
